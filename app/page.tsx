        ...
        <div className='px-8'>
          ...
          <div className='mb-32'>
            ...
            <div className='flex mb-8 content-center'>
              <p className='text-2xl text-white mr-8'>{`At SOLA, we believe in the power of light to illuminate not just spaces but also the rich heritage and traditions that shape our world. We are a passionate team dedicated to preserving cultural heritage through innovative and beautifully crafted lighting solutions.`}</p>
              <Image src={'/assets/images/logo.png'} width={300} height={100} alt='SOLA' />
            </div>
          </div>
          ...
          <div>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <div className='flex gap-2'>
                ...
                <p className='text-2xl whitespace-pre-wrap text-white'>{`sola.luxury@gmail.com`}</p>
              </div>
            </div>
          </div>
        </div>
